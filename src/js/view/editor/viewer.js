...
class Viewer extends View {
  constructor () {
    ...
    this.$viewModeChangeButton = createCustomElement('div', {class: 'view-type-btns'});
    ...
    this.$viewModeChangeButton.append(this.$editorViewBtn, this.$gridViewBtn);
    ...
    this.$view.append(this.$viewModeChangeButton, this.$slideCarousel);

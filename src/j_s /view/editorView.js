...
class EditorView extends View {
  ...
  initListeners () {
    ...
    // this.addListener(this.titlebar.$view, 'change', this.controller.eventHandler);
  ...
  addListener (target, type, callback) {
    target.addEventListener(type, e => callback.bind(this, e.target));
  }
